...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'reservation_details_id'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'no_of_guests'); ?>
		<?php echo $form->textField($model,'no_of_guests'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'no_of_table'); ?>
		<?php echo $form->textField($model,'no_of_table'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'no_of_chair'); ?>
