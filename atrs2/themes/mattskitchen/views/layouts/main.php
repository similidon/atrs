...
<div class="container" id="wrapper">
  ...
  <header id="header">
    <div id="logo"><?php echo CHtml::encode("Aling Tonya's") ?></div>

    <nav id="mainmenu">
      <?php
        $menuItems = array(
          array('label'=>'Home', 'url'=>array('/site/index')),
          array('label'=>'Create', 'url'=>array('/site/page', 'view'=>'about')),
          array('label'=>'View', 'url'=>array('/site/page', 'view'=>'view')),
          array('label'=>'View', 'url'=>array('/site/contact')),
